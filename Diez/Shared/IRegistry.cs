namespace Diez.Shared
{
    public interface IRegistry<TService>
    {
        ...
        void TryAddScoped<TImplementation>() where TImplementation : notnull, TService;

        void TryAddScoped<TImplementation>(Func<IServiceProvider, TImplementation> factory) 
            where TImplementation : notnull, TService;

        void AddSingleton<TImplementation>() where TImplementation : notnull, TService;

        void AddSingleton<TImplementation>(Func<IServiceProvider, TImplementation> factory) 
            where TImplementation : notnull, TService;

        void TryAddSingleton<TImplementation>() where TImplementation : notnull, TService;

        void TryAddSingleton<TImplementation>(Func<IServiceProvider, TImplementation> factory) 
            where TImplementation : notnull, TService;
    }
}